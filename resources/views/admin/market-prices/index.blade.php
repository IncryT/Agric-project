<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.market-prices.create') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 transition">
                + Manual Entry
            </a>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm ring-1 ring-gray-200 sm:rounded-lg">
                ...
                <div class="px-6 py-4 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-4">
                    ...
                    <form method="GET" action="{{ route('admin.market-prices.index') }}" class="flex items-center space-x-2 w-full sm:w-auto">
                    ...
                    <div class="flex items-center space-x-2 w-full sm:w-auto justify-end">
                        ...
                        <form method="GET" action="{{ route('admin.market-prices.index') }}">
                            @if($search)
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            @forelse ($marketPrices as $data)
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-bold bg-green-100 text-green-800 border border-green-200">
                                            ${{ number_format($data->price, 2) }}
                                        </span>
                                    </td>

                                    <!--<td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="#" class="text-indigo-600 hover:text-indigo-900 transition">Manage</a>
                                    </td>-->
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-12 whitespace-nowrap text-sm text-gray-500 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <span class="font-medium text-gray-900">No records found</span>
                                            <p class="mt-1">Adjust your search or add new market prices.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
